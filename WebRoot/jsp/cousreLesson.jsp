...
<script type="text/javascript" src ="<%=request.getContextPath() %>/js/cousreLesson.js"></script>

</head>
<body>
<div id="dataInfo" style="width: auto; text-align: center;">
	</div>
</body>
</html>